package ca.spottedleaf.sectortool;

import ca.spottedleaf.sectortool.analyse.Analyse;
import ca.spottedleaf.sectortool.conversion.ConvertWorld;
import ca.spottedleaf.sectortool.conversion.DeConvertWorld;
import ca.spottedleaf.sectortool.conversion.VerifyWorld;
...
public class Main {
    ...
    public static enum Operation {
        ...
        FUZZ("fuzz"), ANALYSE("analyse"), DECONVERT("deconv");
